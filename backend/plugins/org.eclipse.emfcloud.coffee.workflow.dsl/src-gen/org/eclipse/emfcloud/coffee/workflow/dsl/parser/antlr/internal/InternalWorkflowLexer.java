...
public class InternalWorkflowLexer extends Lexer {
   ...
   public InternalWorkflowLexer(final CharStream input) {
      this(input, new RecognizerSharedState());
   }

   public InternalWorkflowLexer(final CharStream input, final RecognizerSharedState state) {
      super(input, state);
   ...
   public final void mRULE_ID() throws RecognitionException {
      try {
         int _type = RULE_ID;
         int _channel = DEFAULT_TOKEN_CHANNEL;
         // InternalWorkflow.g:417:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0'
         // .. '9' )* )
         // InternalWorkflow.g:417:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0'
         // .. '9' )*
         {
            // InternalWorkflow.g:417:11: ( '^' )?
            int alt1 = 2;
            ...
            // InternalWorkflow.g:417:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2: do {
               int alt2 = 2;
   ...
   public final void mRULE_INT() throws RecognitionException {
      try {
         int _type = RULE_INT;
         int _channel = DEFAULT_TOKEN_CHANNEL;
         // InternalWorkflow.g:419:10: ( ( '0' .. '9' )+ )
         // InternalWorkflow.g:419:12: ( '0' .. '9' )+
         {
            // InternalWorkflow.g:419:12: ( '0' .. '9' )+
            int cnt3 = 0;
            loop3: do {
   ...
   public final void mRULE_STRING() throws RecognitionException {
      try {
         ...
         int _channel = DEFAULT_TOKEN_CHANNEL;
         // InternalWorkflow.g:421:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( (
         // '\\\\' | '\\'' ) ) )* '\\'' ) )
         // InternalWorkflow.g:421:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( (
         // '\\\\' | '\\'' ) ) )* '\\'' )
         {
            // InternalWorkflow.g:421:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( (
            // '\\\\' | '\\'' ) ) )* '\\'' )
            ...
            switch (alt6) {
               case 1:
               // InternalWorkflow.g:421:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
               {
                  match('\"');
                  // InternalWorkflow.g:421:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                  loop4: do {
                     int alt4 = 3;
                  ...
                  break;
               case 2:
               // InternalWorkflow.g:421:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
               {
                  match('\'');
                  // InternalWorkflow.g:421:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                  loop5: do {
                     int alt5 = 3;
   ...
   public final void mRULE_ML_COMMENT() throws RecognitionException {
      try {
         ...
         int _channel = DEFAULT_TOKEN_CHANNEL;
         // InternalWorkflow.g:423:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
         // InternalWorkflow.g:423:19: '/*' ( options {greedy=false; } : . )* '*/'
         {
            match("/*");

            // InternalWorkflow.g:423:24: ( options {greedy=false; } : . )*
            loop7: do {
               int alt7 = 2;
   ...
   public final void mRULE_SL_COMMENT() throws RecognitionException {
      try {
         ...
         int _channel = DEFAULT_TOKEN_CHANNEL;
         // InternalWorkflow.g:425:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
         // InternalWorkflow.g:425:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
         {
            match("//");

            // InternalWorkflow.g:425:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8: do {
               int alt8 = 2;
   ...
   public final void mRULE_WS() throws RecognitionException {
      try {
         int _type = RULE_WS;
         int _channel = DEFAULT_TOKEN_CHANNEL;
         // InternalWorkflow.g:427:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
         // InternalWorkflow.g:427:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
         {
            // InternalWorkflow.g:427:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11 = 0;
            loop11: do {
   ...
   public final void mRULE_ANY_OTHER() throws RecognitionException {
      try {
         ...
         int _channel = DEFAULT_TOKEN_CHANNEL;
         // InternalWorkflow.g:429:16: ( . )
         // InternalWorkflow.g:429:18: .
         {
            matchAny();
   ...
   public void mTokens() throws RecognitionException {
      // InternalWorkflow.g:1:8: ( T__11 | T__12 | T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21
   ...
   static final String DFA12_eotS = "\1\uffff\1\25\1\uffff\2\25\1\uffff\1\22\3\25\1\uffff\1\22\2\uffff\3\22\2\uffff\2\25\2\uffff\2\25\2\uffff\3\25\6\uffff\5\25\1\60\6\25\1\uffff\1\67\5\25\1\uffff\1\25\1\76\3\25\1\102\1\uffff\3\25\1\uffff\1\106\2\25\1\uffff\2\25\1\113\1\25\1\uffff\2\25\1\117\1\uffff";
   static final String DFA12_eofS = "\120\uffff";
   ...
   static final String DFA12_maxS = "\1\uffff\1\145\1\uffff\1\157\1\163\1\uffff\1\76\1\162\1\157\1\151\1\uffff\1\172\2\uffff\2\uffff\1\57\2\uffff\1\143\1\144\2\uffff\1\162\1\163\2\uffff\1\157\1\167\1\147\6\uffff\1\150\1\151\1\153\1\145\1\142\1\172\1\150\1\151\1\165\1\146\1\162\1\141\1\uffff\1\172\1\156\1\155\1\154\1\164\1\142\1\uffff\1\145\1\172\1\157\2\151\1\172\1\uffff\1\167\1\157\1\154\1\uffff\1\172\1\156\1\151\1\uffff\1\163\1\164\1\172\1\151\1\uffff\1\145\1\163\1\172\1\uffff";
   static final String DFA12_acceptS = "\2\uffff\1\2\2\uffff\1\5\4\uffff\1\13\1\uffff\1\14\1\15\3\uffff\1\21\1\22\2\uffff\1\14\1\2\2\uffff\1\5\1\6\3\uffff\1\13\1\15\1\16\1\17\1\20\1\21\14\uffff\1\10\6\uffff\1\12\6\uffff\1\11\3\uffff\1\1\3\uffff\1\3\4\uffff\1\4\3\uffff\1\7";
   static final String DFA12_specialS = "\1\1\15\uffff\1\0\1\2\100\uffff}>";
      ...
      public int specialStateTransition(int s, final IntStream _input) throws NoViableAltException {
         ...
         switch (s) {
            ...
            case 1:
               ...
               else if (((LA12_0 >= 'A' && LA12_0 <= 'Z') || LA12_0 == '_' || (LA12_0 >= 'b' && LA12_0 <= 'g')
                  || (LA12_0 >= 'i' && LA12_0 <= 'k') || (LA12_0 >= 'n' && LA12_0 <= 'o')
                  || (LA12_0 >= 'q' && LA12_0 <= 'v') || (LA12_0 >= 'x' && LA12_0 <= 'z'))) {
                  s = 12;
               }
