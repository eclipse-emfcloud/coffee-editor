...
<com.eclipsesource.modelserver.coffee.model:Machine xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:com.eclipsesource.modelserver.coffee.model="http://www.eclipsesource.com/modelserver/example/coffeemodel" name="SuperBrewer3000">
  ...
  <workflows name="BrewingFlow">
    ...
    <nodes xsi:type="com.eclipsesource.modelserver.coffee.model:ManualTask" name="Drink"/>
    <nodes xsi:type="com.eclipsesource.modelserver.coffee.model:ManualTask" name="Push"/>
    <nodes xsi:type="com.eclipsesource.modelserver.coffee.model:ManualTask" name="Check drip tray"/>
    <nodes xsi:type="com.eclipsesource.modelserver.coffee.model:AutomaticTask" name="Check Water"/>
    <nodes xsi:type="com.eclipsesource.modelserver.coffee.model:AutomaticTask" name="Water Ok"/>
    <nodes xsi:type="com.eclipsesource.modelserver.coffee.model:Decision"/>
    <nodes xsi:type="com.eclipsesource.modelserver.coffee.model:Merge"/>
    <flows source="//@workflows.0/@nodes.4" target="//@workflows.0/@nodes.6"/>
    <flows source="//@workflows.0/@nodes.6" target="//@workflows.0/@nodes.8"/>
    <flows xsi:type="com.eclipsesource.modelserver.coffee.model:WeightedFlow" source="//@workflows.0/@nodes.8" target="//@workflows.0/@nodes.2"/>
    <flows xsi:type="com.eclipsesource.modelserver.coffee.model:WeightedFlow" source="//@workflows.0/@nodes.8" target="//@workflows.0/@nodes.7"/>
    ...
    <flows xsi:type="com.eclipsesource.modelserver.coffee.model:WeightedFlow" source="//@workflows.0/@nodes.1" target="//@workflows.0/@nodes.3"/>
  </workflows>
